...
export default function Personal() {
  ...
  const {fetchUsers, fetchRemove} = useActions()
  ...
  function removeUser(id) {
    const delId = id;
    fetchRemove('https://sf-final-project-be.herokuapp.com/api/officers/', delId, localStorage.getItem('myToken'))
    fetchUsers(localStorage.getItem('myToken'), 'get', 'https://sf-final-project-be.herokuapp.com/api/officers/');
    ...
    <main className="main"> 
      <div className='container container-person'>
        <div className="btn_top">
          <a href="/registration" className="btn">Зарегистрировать нового</a>
        </div>
        <h1 className="page__title">Все сотрудники</h1>
